...
int mirx,miry;
float r1=245.0,g1=150.0,b1=170.0;
int trap =0;
boolean sw;
...
void draw() {
  ...
  if(enter == 1){
    ...
    box(0.1,height*1.5,0.1);
    popMatrix();

    pushMatrix();
    translate(width*1.3,height/2,-(width-height)/2);
    box(0.1,height*1.5,0.1);
    popMatrix();
    
    pushMatrix();
    translate(width/2,-100,-(width-height)/2);
    box(width*1.4,0.1,0.1);
    popMatrix();
    
    pushMatrix();
    translate(width/2,height*1.2,-(width-height)/2);
    box(width*1.4,0.1,0.1);
    popMatrix();
    ...
    if(mode == 0){
      ...
      box(10,height*1.46,20);
      popMatrix();

      pushMatrix();
      translate(width*1.22+10,height/2,-(width-height)/2);
      box(10,height*1.46,20);
      popMatrix();
    
      pushMatrix();
      translate(width/2,-240,-(width-height)/2);
      box(width*1.46,10,20);
      popMatrix();
    
      pushMatrix();
      translate(width/2,height*1.22,-(width-height)/2);
      box(width*1.46,10,20);
      popMatrix();
